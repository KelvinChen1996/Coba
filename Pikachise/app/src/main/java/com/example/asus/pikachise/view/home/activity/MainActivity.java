...
import com.example.asus.pikachise.view.event.fragment.BookedEventFragment;
...
import com.example.asus.pikachise.view.help.HelpFragment;
...
//                                    AddNotification(integer.toString());
    ...
    public void GetNotificationCountWithAlert() {
        service.Get_Notification_Count(token)
                .enqueue(new Callback<ResponseBody>() {
                    @Override
                    public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
...
//                                    AddNotification(integer.toString());
    ...
    //Add Notification
    public void AddNotification(String count) {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                switch (item.getItemId()){
                    ...
                    case R.id.usernavitem_interestedlist:
                        disableCollapse();
                        toolbar.setTitle("Favorited List");
                    ...
                    case R.id.usernavitem_guides:
                        disableCollapse();
                        toolbar.setTitle("Helps");
                        CurrentSelectedPosition = 9;
                        fragmentTransaction = fragmentManager.beginTransaction();
                        fragmentTransaction.replace(R.id.usermain_containerview, new HelpFragment()).commit();
                        break;
                    ...
                    case R.id.usernavitem_booked:
                        ...
                        fragmentTransaction = fragmentManager.beginTransaction();
                        fragmentTransaction.replace(R.id.usermain_containerview, new BookedEventFragment()).commit();
                        break;

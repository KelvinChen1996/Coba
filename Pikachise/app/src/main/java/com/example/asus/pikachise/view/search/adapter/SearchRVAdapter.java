...
public class SearchRVAdapter extends RecyclerView.Adapter<SearchRVAdapter.EventHolder>{
    ...
    Context context;
    public SearchRVAdapter(List<ListFranchise> listFranchises, Context context){
        this.context = context;
        this.listFranchises = listFranchises;
    }
    @Override
    public SearchRVAdapter.EventHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_franchise, parent, false);
        return new EventHolder(view);
    }

    @Override
    public void onBindViewHolder(SearchRVAdapter.EventHolder holder, int position) {
    ...
    public class EventHolder extends RecyclerView.ViewHolder {
        ...
        @BindView(R.id.itemfranchise_conitemroot)
    ...
    public void setFilter(List<ListFranchise> newdaftarFranchise){

        this.listFranchises = new ArrayList<>();
        this.listFranchises.addAll(newdaftarFranchise);

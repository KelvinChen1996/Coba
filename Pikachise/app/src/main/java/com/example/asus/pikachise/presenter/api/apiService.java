...
public interface apiService {
    ...
    @FormUrlEncoded
    @POST("franchise/get_franchise_event")
    Call<EventResponse> getmyfranchiseEvent (@Field("token") String token,
                                             @Field("franchise_id") String franchise_id);

    @FormUrlEncoded
    @POST("franchise/allow_book_event")
    Call<ResponseBody> AllowBookEvent(@Field("token") String token,
                                       @Field("event_id") String event_id);

    @FormUrlEncoded
    @POST("franchise/book_event")
    Call<ResponseBody> BookEvent(@Field("token") String token,
                                  @Field("event_id") String event_id,
                                  @Field("qrcode") String qrcode);
    @FormUrlEncoded
    @POST("franchise/my_booked_events")
    Call<MyEventResponse> getBookEvent(@Field("token") String token);

    @Multipart
    @POST("franchise/edit_franchise")
    Call<ResponseBody> editfranchiseRequest(
            @Part("token") RequestBody token,
            @Part("franchise_id") RequestBody franchise_id,
            @Part("name") RequestBody name,
            @Part("category") RequestBody category,
    ...
    @Multipart
    @POST("franchise/edit_franchise_logo_banner")
    Call<ResponseBody> editfranchiselogobannerRequest(
            @Part("token") RequestBody token,
            @Part MultipartBody.Part logo,
            @Part MultipartBody.Part banner
    );
    @Multipart
    @POST("franchise/edit_franchise_logo_banner")
    Call<ResponseBody> editfranchisebannerRequest(
            @Part("token") RequestBody token,
            @Part MultipartBody.Part banner
    );
    @Multipart
    @POST("franchise/edit_franchise_logo_banner")
    Call<ResponseBody> editfranchiselogoRequest(
            @Part("token") RequestBody token,
            @Part MultipartBody.Part logo
    );

    @Multipart
    @POST("auth/change_user_image")
    Call<ResponseBody> changeuserimageRequest(
            @Part("token") RequestBody token,
            @Part MultipartBody.Part image
    );
    @FormUrlEncoded
    @POST("franchise/edit_event")
    Call<ResponseBody> editEventRequest(@Field("token") String token,
                                        @Field("event_id") String event_id,
    ...
    @Multipart
    @POST("franchise/change_event_image")
    Call<ResponseBody> changeeventimageRequest(
            @Part("token") RequestBody token,
            @Part MultipartBody.Part image
    );
    ...
    Call<ListFranchiseResponse> List_by_Price_Range(
            @Field("token") String token,
            @Field("alphabet_order") String order,
            @Field("min_value") String min_value,
            @Field("max_value") String max_value,
            @Field("category") String category);

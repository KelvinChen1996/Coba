...
public class MyFranchiseRVAdapter extends RecyclerView.Adapter<MyFranchiseRVAdapter.ViewHolder> {
    ...
    private String statusverified = "", status = "";
...
//                .into(holder.logo);
        Picasso.with(context)
                ...
                .placeholder(R.drawable.logo404)
                .into(holder.logo);
        statusverified = current.getStatusVerified();
        status = current.getStatus();
        if (status.equals("Franchisor"))
        {
            holder.role.setText("Franchisor");
            holder.roleimage.setImageResource(R.drawable.franchisor);
        }else{
            holder.role.setText("Franchisee");
            holder.roleimage.setImageResource(R.drawable.franchisee);
        }
        if(statusverified.equals("pending")){
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        @BindView(R.id.itemmyfranchise_role) TextView role;
        @BindView(R.id.itemmyfranchise_roleimage) ImageView roleimage;

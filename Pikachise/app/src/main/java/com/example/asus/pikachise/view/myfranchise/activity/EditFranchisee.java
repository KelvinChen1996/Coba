...
public class EditFranchisee extends AppCompatActivity implements DatePickerDialog.OnDateSetListener{
    ...
    @BindView(R.id.editfranchisee_openfromgooglemaps) LinearLayout openfromgooglemaps;
    @BindView(R.id.editfranchisee_layoutlongitude) TextInputLayout layoutlongitude;
    @BindView(R.id.editfranchisee_layoutlatitude) TextInputLayout layoutlatitude;
    @BindView(R.id.editfranchisee_latitude) TextInputEditText latitude;
    @BindView(R.id.editfranchisee_longitude) TextInputEditText longitude;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String pisah[] = extraaddress.split("%");
        address.setText(pisah[0]);
        latitude.setText(pisah[1]);
        longitude.setText(pisah[2]);
    ...
    private void editfranchisee(){
        ...
        String gabung = address.getText().toString() + "%" + lat + "%" + lo;
        service.editmyfranchisee(extraoutletid, gabung, phonenumber.getText().toString(), since.getText().toString(), token)
